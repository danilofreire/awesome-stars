...
- [UditAkhourii/adhd](https://github.com/UditAkhourii/adhd) - ADHD — a skill for coding agents. Tree-of-thought with pruning, built on the Claude Agent SDK. Fans out parallel divergent thoughts under different cognitive frames, scores, prunes traps, deepens the 
...
- [mcanouil/quarto-revealjs-spotlight](https://github.com/mcanouil/quarto-revealjs-spotlight) - A Quarto extension for Reveal.js allowing to highlight the current mouse position with a spotlight.
...
- [jupyterlab-contrib/jupyterlab-citation-manager](https://github.com/jupyterlab-contrib/jupyterlab-citation-manager) - Citation Manager for JupyterLab using Zotero Web API
...
- [tidyverse/datascience-box](https://github.com/tidyverse/datascience-box) - Data Science Course in a Box
- [cran-task-views/AnomalyDetection](https://github.com/cran-task-views/AnomalyDetection) - CRAN Task View: Anomaly Detection
- [randy3k/radian](https://github.com/randy3k/radian) - A 21 century R console
- [ropensci/charlatan](https://github.com/ropensci/charlatan) - Create fake data in R
