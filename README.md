...
- [YaohuiZeng/biglasso](https://github.com/YaohuiZeng/biglasso) - biglasso: Extending Lasso Model Fitting to Big Data in R
...
- [pedrosan/CausalModeling](https://github.com/pedrosan/CausalModeling) - 
...
- [brianchung808/git-clone](https://github.com/brianchung808/git-clone) - 
...
- [diegoquintanav/pinochet-analyze](https://github.com/diegoquintanav/pinochet-analyze) - A repository for exploring the pinochet dataset [freire2019pinoche]
...
- [Azure-Samples/learnAnalytics-MicrosoftML](https://github.com/Azure-Samples/learnAnalytics-MicrosoftML) - Introduction to Statistical Machine Learning with MicrosoftML
- [larmarange/analyse-R](https://github.com/larmarange/analyse-R) - Introduction à l'analyse d'enquêtes avec R et RStudio
...
- [shftan/surfin](https://github.com/shftan/surfin) - Statistical Inference for Random Forests
...
- [Classes-kbenoit/quants3](https://github.com/Classes-kbenoit/quants3) - Quants III: Data Mining and Statistical Learning
...
- [bd2kccd/r-causal](https://github.com/bd2kccd/r-causal) - R Wrapper for Tetrad Library
- [udacity/ud843-QuakeReport](https://github.com/udacity/ud843-QuakeReport) - Discover earthquake activity around the world.
- [udacity/ud843_DidYouFeelIt](https://github.com/udacity/ud843_DidYouFeelIt) - 
...
- [trainindata/feature-engineering-for-time-series-forecasting](https://github.com/trainindata/feature-engineering-for-time-series-forecasting) - 
...
- [dlab-berkeley/Python-Data-Wrangling](https://github.com/dlab-berkeley/Python-Data-Wrangling) - D-Lab's 3 hour introduction to data wrangling in Python. Learn how to import and manipulate dataframes using pandas in Python.
- [dlab-berkeley/R-Geospatial-Fundamentals](https://github.com/dlab-berkeley/R-Geospatial-Fundamentals) - This is the repository for D-Lab's Geospatial Fundamentals in R with sf workshop.
...
- [sebastianbarfort/intro-r-phd](https://github.com/sebastianbarfort/intro-r-phd) - Introduction to R, PhD course at University of Copenhagen
...
- [seade-R/dados-covid-sp](https://github.com/seade-R/dados-covid-sp) - Repositório de dados sobre SARS-COV-2 em municípios paulistas
...
- [Pakillo/getting-job-data-science](https://github.com/Pakillo/getting-job-data-science) - Collection of advice and resources for getting a job as data scientist
...
- [dscov-tutorials/schedule_and_links](https://github.com/dscov-tutorials/schedule_and_links) - Schedule of tutorials and list of relevant materials
...
- [erikgahner/poliscijournals](https://github.com/erikgahner/poliscijournals) - Overview of word limits in political science journals
...
- [callmespring/CausalRL](https://github.com/callmespring/CausalRL) - Implementation of "Dynamic Causal Effects Evaluation in A/B Testing with a Reinforcement Learning Framework" (JASA 2021+)
...
- [sktime/sktime-dl](https://github.com/sktime/sktime-dl) - sktime companion package for deep learning based on TensorFlow
...
- [UppsalaConflictDataProgram/OpenViEWS2](https://github.com/UppsalaConflictDataProgram/OpenViEWS2) - Public version of new ViEWS repository.
...
- [UppsalaConflictDataProgram/OpenViEWS](https://github.com/UppsalaConflictDataProgram/OpenViEWS) - This is the public code repository for the ViEWS project.
...
- [tidymodels/brulee](https://github.com/tidymodels/brulee) - High-Level Modeling Functions with 'torch'
...
- [t-davidson/computational-sociology](https://github.com/t-davidson/computational-sociology) - SOC577 Computational Sociology, Spring 2021, Rutgers University
...
- [business-science/modeltime.ensemble](https://github.com/business-science/modeltime.ensemble) - Time Series Ensemble Forecasting
...
- [emitanaka/edibble](https://github.com/emitanaka/edibble) - An R-package to construct designs using the grammar of experimental designs
...
- [macartan/CausalQueries](https://github.com/macartan/CausalQueries) - Bayesian inference from binary causal models
...
- [andybega/acledr](https://github.com/andybega/acledr) - Download and read the ACLED event data
...
- [DiegoKoz/presentes](https://github.com/DiegoKoz/presentes) - R-package with data from the victims of the state terrorism in Argentina
...
- [aboulaboul/automl](https://github.com/aboulaboul/automl) - Deep Learning with Metaheuristic
...
- [leeper/pdfcount](https://github.com/leeper/pdfcount) - An R Shiny App to Count Words in a PDF Document
...
- [CenterForPeaceAndSecurityStudies/IntroductiontoMachineLearning](https://github.com/CenterForPeaceAndSecurityStudies/IntroductiontoMachineLearning) - Course Materials for Introduction to Machine Learning, Rex W. Douglass 2018
- [monogenea/CNNtutorial](https://github.com/monogenea/CNNtutorial) - Convolutional Neural Networks tutorial 🐶🐱
...
- [mvuorre/brmstools](https://github.com/mvuorre/brmstools) - Helper functions for brmsfit objects (DEPRECATED)
...
- [OuhscBbmc/Wats](https://github.com/OuhscBbmc/Wats) - Code to accompany WATS Plot article
...
- [Cepesp-Fgv/cepesp-r](https://github.com/Cepesp-Fgv/cepesp-r) - 
...
- [khakieconomics/nowcasting_in_stan](https://github.com/khakieconomics/nowcasting_in_stan) - Simple demonstration of nowcasting in stan
...
- [jalvesaq/DataEntry](https://github.com/jalvesaq/DataEntry) - Make it easier to enter questionnaire data
...
- [danilofreire/climate-governance](https://github.com/danilofreire/climate-governance) - Replication materials for the paper "Institutional Design and Elite Support for Climate Policies: Evidence from Latin American Countries" (2020)
...
- [zmjones/eeesr](https://github.com/zmjones/eeesr) - "An Empirical Evaluation of Explanations for State Repression"
...
- [danilofreire/vimrc](https://github.com/danilofreire/vimrc) - My (neo)vim configuration files
